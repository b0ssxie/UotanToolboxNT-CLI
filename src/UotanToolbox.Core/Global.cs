...
namespace UotanToolbox.Common
{
    public class Global
    {
        ...
        /// <summary>
        /// Use the native C fastboot (fastbootcli) instead of the AOSP fastboot.
        /// </summary>
        public static bool UseNativeFastboot = false;

        public static string BootPatchPath { get; set; } = string.Empty;
        public static string MagiskAPKPath { get; set; } = string.Empty;
        ...
        public static string FastbootPath
        {
            get
            {
                string name = UseNativeFastboot ? "fastbootcli" : "fastboot";
                if (System == "Windows")
                    name += ".exe";
